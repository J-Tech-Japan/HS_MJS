...
namespace WordAddIn1
{
    public partial class RibbonMJS
    {
        ...
        private void ExtractProductLogosPattern1Pattern2(Document docCopy, Word.Application application, string strOutFileName, List<List<string>> productSubLogoGroups, StreamWriter log)
        {
        ...
        private void ExtractProductLogosPattern3(Document docCopy, Word.Application application, string strOutFileName, List<List<string>> productSubLogoGroups, StreamWriter log)
        {
            int productSubLogoCount = 0;
